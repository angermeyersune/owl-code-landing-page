  ...
  return (
    <section className="py-16 md:py-24 bg-lingoowl-light">
      <div className="max-w-7xl mx-auto px-4 md:px-10 text-center">
        ...
        <p className="text-lg text-[#10162f] mb-8 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button variant="outline" className="border-lingoowl-purple text-[#10162f] hover:bg-[#FFFAE5] px-8 py-6 text-lg h-auto">
            Contact sales
          </Button>
        </div>
      </div>
