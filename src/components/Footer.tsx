        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Helping language learners achieve fluency through expert advice and proven techniques.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition">Language Guides</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Vocabulary Lists</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Study Techniques</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Practice Tools</a></li>
            </ul>
          </div>
